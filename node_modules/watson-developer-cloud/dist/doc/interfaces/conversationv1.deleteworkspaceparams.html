...
<head>
	...
	<title>DeleteWorkspaceParams | watson-developer-cloud</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="conversationv1.deleteworkspaceparams.html">DeleteWorkspaceParams</a>
				</li>
			</ul>
			<h1>Interface DeleteWorkspaceParams</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Parameters for the <code>deleteWorkspace</code> operation.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">DeleteWorkspaceParams</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="conversationv1.deleteworkspaceparams.html#headers" class="tsd-kind-icon">headers</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="conversationv1.deleteworkspaceparams.html#workspace_id" class="tsd-kind-icon">workspace_<wbr>id</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/conversation/v1-generated.ts#L2278">conversation/v1-generated.ts:2278</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/conversation/v1-generated.ts#L2277">conversation/v1-generated.ts:2277</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
					...
					<li class="current tsd-kind-class">
						...
						<ul>
							<li class="current tsd-kind-interface tsd-parent-kind-class">
								<a href="conversationv1.deleteworkspaceparams.html" class="tsd-kind-icon">Delete<wbr>Workspace<wbr>Params</a>
								<ul>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="conversationv1.deleteworkspaceparams.html#headers" class="tsd-kind-icon">headers</a>
									</li>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="conversationv1.deleteworkspaceparams.html#workspace_id" class="tsd-kind-icon">workspace_<wbr>id</a>
									</li>
								</ul>
							</li>
						</ul>
