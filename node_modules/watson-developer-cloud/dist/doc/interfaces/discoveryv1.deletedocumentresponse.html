...
<head>
	...
	<title>DeleteDocumentResponse | watson-developer-cloud</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="discoveryv1.deletedocumentresponse.html">DeleteDocumentResponse</a>
				</li>
			</ul>
			<h1>Interface DeleteDocumentResponse</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			...
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">DeleteDocumentResponse</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="discoveryv1.deletedocumentresponse.html#document_id" class="tsd-kind-icon">document_<wbr>id</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="discoveryv1.deletedocumentresponse.html#status" class="tsd-kind-icon">status</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/discovery/v1-generated.ts#L2849">discovery/v1-generated.ts:2849</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/discovery/v1-generated.ts#L2851">discovery/v1-generated.ts:2851</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
							<p>Status of the document. A deleted document has the status deleted.</p>
						</div>
					</div>
				</section>
			</section>
					...
					<li class="current tsd-kind-class">
						...
						<ul>
							<li class="current tsd-kind-interface tsd-parent-kind-class">
								<a href="discoveryv1.deletedocumentresponse.html" class="tsd-kind-icon">Delete<wbr>Document<wbr>Response</a>
								<ul>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="discoveryv1.deletedocumentresponse.html#document_id" class="tsd-kind-icon">document_<wbr>id</a>
									</li>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="discoveryv1.deletedocumentresponse.html#status" class="tsd-kind-icon">status</a>
									</li>
								</ul>
							</li>
						</ul>
