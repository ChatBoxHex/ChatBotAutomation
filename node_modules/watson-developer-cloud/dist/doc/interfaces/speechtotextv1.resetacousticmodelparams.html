...
<head>
	...
	<title>ResetAcousticModelParams | watson-developer-cloud</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="speechtotextv1.resetacousticmodelparams.html">ResetAcousticModelParams</a>
				</li>
			</ul>
			<h1>Interface ResetAcousticModelParams</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Parameters for the <code>resetAcousticModel</code> operation.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">ResetAcousticModelParams</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="speechtotextv1.resetacousticmodelparams.html#customization_id" class="tsd-kind-icon">customization_<wbr>id</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="speechtotextv1.resetacousticmodelparams.html#headers" class="tsd-kind-icon">headers</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/speech-to-text/v1-generated.ts#L2077">speech-to-text/v1-generated.ts:2077</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
							<p>The GUID of the custom acoustic model that is to be reset. You must make the request with service credentials created for the instance of the service that owns the custom model.</p>
						</div>
					</div>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/speech-to-text/v1-generated.ts#L2078">speech-to-text/v1-generated.ts:2078</a></li>
						</ul>
					</aside>
				</section>
			</section>
					...
					<li class="current tsd-kind-class">
						...
						<ul>
							<li class="current tsd-kind-interface tsd-parent-kind-class">
								<a href="speechtotextv1.resetacousticmodelparams.html" class="tsd-kind-icon">Reset<wbr>Acoustic<wbr>Model<wbr>Params</a>
								<ul>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="speechtotextv1.resetacousticmodelparams.html#customization_id" class="tsd-kind-icon">customization_<wbr>id</a>
									</li>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="speechtotextv1.resetacousticmodelparams.html#headers" class="tsd-kind-icon">headers</a>
									</li>
								</ul>
							</li>
						</ul>
