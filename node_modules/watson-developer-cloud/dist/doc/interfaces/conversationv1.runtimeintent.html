...
<head>
	...
	<title>RuntimeIntent | watson-developer-cloud</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="conversationv1.runtimeintent.html">RuntimeIntent</a>
				</li>
			</ul>
			<h1>Interface RuntimeIntent</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>An intent identified in the user input.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">RuntimeIntent</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="conversationv1.runtimeintent.html#confidence" class="tsd-kind-icon">confidence</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="conversationv1.runtimeintent.html#intent" class="tsd-kind-icon">intent</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/conversation/v1-generated.ts#L3460">conversation/v1-generated.ts:3460</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
							<p>A decimal percentage that represents Watson&#39;s confidence in the intent.</p>
						</div>
					</div>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/conversation/v1-generated.ts#L3458">conversation/v1-generated.ts:3458</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
							<p>The name of the recognized intent.</p>
						</div>
					</div>
				</section>
			</section>
					...
					<li class="current tsd-kind-class">
						...
						<ul>
							<li class="current tsd-kind-interface tsd-parent-kind-class">
								<a href="conversationv1.runtimeintent.html" class="tsd-kind-icon">Runtime<wbr>Intent</a>
								<ul>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="conversationv1.runtimeintent.html#confidence" class="tsd-kind-icon">confidence</a>
									</li>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="conversationv1.runtimeintent.html#intent" class="tsd-kind-icon">intent</a>
									</li>
								</ul>
							</li>
						</ul>
