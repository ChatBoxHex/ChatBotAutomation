...
<head>
	...
	<title>Context | watson-developer-cloud</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="conversationv1.context.html">Context</a>
				</li>
			</ul>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>State information for the conversation. To maintain state, include the context from the previous response.</p>
					</div>
				</div>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="conversationv1.context.html#conversation_id" class="tsd-kind-icon">conversation_<wbr>id</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="conversationv1.context.html#system" class="tsd-kind-icon">system</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<h3><span class="tsd-flag ts-flagOptional">Optional</span> conversation_<wbr>id</h3>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/conversation/v1-generated.ts#L3034">conversation/v1-generated.ts:3034</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<div class="tsd-signature tsd-kind-icon">system<span class="tsd-signature-symbol">:</span> <a href="conversationv1.systemresponse.html" class="tsd-signature-type">SystemResponse</a></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/conversation/v1-generated.ts#L3036">conversation/v1-generated.ts:3036</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
					...
					<li class="current tsd-kind-class">
						...
						<ul>
							<li class="current tsd-kind-interface tsd-parent-kind-class">
								<a href="conversationv1.context.html" class="tsd-kind-icon">Context</a>
								<ul>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="conversationv1.context.html#conversation_id" class="tsd-kind-icon">conversation_<wbr>id</a>
									</li>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="conversationv1.context.html#system" class="tsd-kind-icon">system</a>
									</li>
								</ul>
							</li>
						</ul>
