...
<head>
	...
	<title>LogMessage | watson-developer-cloud</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="conversationv1.logmessage.html">LogMessage</a>
				</li>
			</ul>
			<h1>Interface LogMessage</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			...
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">LogMessage</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="conversationv1.logmessage.html#level" class="tsd-kind-icon">level</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="conversationv1.logmessage.html#msg" class="tsd-kind-icon">msg</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/conversation/v1-generated.ts#L3358">conversation/v1-generated.ts:3358</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/conversation/v1-generated.ts#L3360">conversation/v1-generated.ts:3360</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
							<p>The text of the log message.</p>
						</div>
					</div>
				</section>
			</section>
					...
					<li class="current tsd-kind-class">
						...
						<ul>
							<li class="current tsd-kind-interface tsd-parent-kind-class">
								<a href="conversationv1.logmessage.html" class="tsd-kind-icon">Log<wbr>Message</a>
								<ul>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="conversationv1.logmessage.html#level" class="tsd-kind-icon">level</a>
									</li>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="conversationv1.logmessage.html#msg" class="tsd-kind-icon">msg</a>
									</li>
								</ul>
							</li>
						</ul>
