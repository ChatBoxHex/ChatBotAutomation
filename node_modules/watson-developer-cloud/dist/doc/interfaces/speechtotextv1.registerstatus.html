...
<head>
	...
	<title>RegisterStatus | watson-developer-cloud</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="speechtotextv1.registerstatus.html">RegisterStatus</a>
				</li>
			</ul>
			<h1>Interface RegisterStatus</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			...
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">RegisterStatus</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="speechtotextv1.registerstatus.html#status" class="tsd-kind-icon">status</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="speechtotextv1.registerstatus.html#url" class="tsd-kind-icon">url</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/speech-to-text/v1-generated.ts#L2368">speech-to-text/v1-generated.ts:2368</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
							<p>The current status of the job: <em> <code>created</code> if the callback URL was successfully white-listed as a result of the call. </em> <code>already created</code> if the URL was already white-listed.</p>
						</div>
					</div>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/speech-to-text/v1-generated.ts#L2370">speech-to-text/v1-generated.ts:2370</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
							<p>The callback URL that is successfully registered.</p>
						</div>
					</div>
				</section>
			</section>
					...
					<li class="current tsd-kind-class">
						...
						<ul>
							<li class="current tsd-kind-interface tsd-parent-kind-class">
								<a href="speechtotextv1.registerstatus.html" class="tsd-kind-icon">Register<wbr>Status</a>
								<ul>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="speechtotextv1.registerstatus.html#status" class="tsd-kind-icon">status</a>
									</li>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="speechtotextv1.registerstatus.html#url" class="tsd-kind-icon">url</a>
									</li>
								</ul>
							</li>
						</ul>
