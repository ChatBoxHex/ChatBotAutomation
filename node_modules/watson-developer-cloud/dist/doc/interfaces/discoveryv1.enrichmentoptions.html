...
<head>
	...
	<title>EnrichmentOptions | watson-developer-cloud</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="discoveryv1.enrichmentoptions.html">EnrichmentOptions</a>
				</li>
			</ul>
			<h1>Interface EnrichmentOptions</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Options which are specific to a particular enrichment.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">EnrichmentOptions</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="discoveryv1.enrichmentoptions.html#features" class="tsd-kind-icon">features</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="discoveryv1.enrichmentoptions.html#model" class="tsd-kind-icon">model</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<div class="tsd-signature tsd-kind-icon">features<span class="tsd-signature-symbol">:</span> <a href="discoveryv1.nluenrichmentfeatures.html" class="tsd-signature-type">NluEnrichmentFeatures</a></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/discovery/v1-generated.ts#L2949">discovery/v1-generated.ts:2949</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
							<p>An object representing the enrichment features that will be applied to the specified field.</p>
						</div>
					</div>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/discovery/v1-generated.ts#L2951">discovery/v1-generated.ts:2951</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
							<p>For use with <code>elements</code> enrichments only.* The element extraction model to use. Models available are: <code>contract</code>.</p>
						</div>
					</div>
				</section>
			</section>
					...
					<li class="current tsd-kind-class">
						...
						<ul>
							<li class="current tsd-kind-interface tsd-parent-kind-class">
								<a href="discoveryv1.enrichmentoptions.html" class="tsd-kind-icon">Enrichment<wbr>Options</a>
								<ul>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="discoveryv1.enrichmentoptions.html#features" class="tsd-kind-icon">features</a>
									</li>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="discoveryv1.enrichmentoptions.html#model" class="tsd-kind-icon">model</a>
									</li>
								</ul>
							</li>
						</ul>
