...
<head>
	...
	<title>ListCollectionFieldsResponse | watson-developer-cloud</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="discoveryv1.listcollectionfieldsresponse.html">ListCollectionFieldsResponse</a>
				</li>
			</ul>
			<h1>Interface ListCollectionFieldsResponse</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The list of fetched fields.  The fields are returned using a fully qualified name format, however, the format differs slightly from that used by the query operations.    <em> Fields which contain nested JSON objects are assigned a type of &quot;nested&quot;.    </em> Fields which belong to a nested object are prefixed with <code>.properties</code> (for example, <code>warnings.properties.severity</code> means that the <code>warnings</code> object has a property called <code>severity</code>).    * Fields returned from the News collection are prefixed with <code>v{N}-fullnews-t3-{YEAR}.mappings</code> (for example, <code>v5-fullnews-t3-2016.mappings.text.properties.author</code>).</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">ListCollectionFieldsResponse</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="discoveryv1.listcollectionfieldsresponse.html#fields" class="tsd-kind-icon">fields</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<div class="tsd-signature tsd-kind-icon">fields<span class="tsd-signature-symbol">:</span> <a href="discoveryv1.field.html" class="tsd-signature-type">Field</a><span class="tsd-signature-symbol">[]</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/discovery/v1-generated.ts#L3041">discovery/v1-generated.ts:3041</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
							<p>An array containing information about each field in the collections.</p>
						</div>
					</div>
				</section>
			</section>
					...
					<li class="current tsd-kind-class">
						...
						<ul>
							<li class="current tsd-kind-interface tsd-parent-kind-class">
								<a href="discoveryv1.listcollectionfieldsresponse.html" class="tsd-kind-icon">List<wbr>Collection<wbr>Fields<wbr>Response</a>
								<ul>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="discoveryv1.listcollectionfieldsresponse.html#fields" class="tsd-kind-icon">fields</a>
									</li>
								</ul>
							</li>
						</ul>
