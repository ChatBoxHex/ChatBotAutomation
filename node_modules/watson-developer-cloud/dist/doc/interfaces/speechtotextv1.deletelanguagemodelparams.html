...
<head>
	...
	<title>DeleteLanguageModelParams | watson-developer-cloud</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="speechtotextv1.deletelanguagemodelparams.html">DeleteLanguageModelParams</a>
				</li>
			</ul>
			<h1>Interface DeleteLanguageModelParams</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Parameters for the <code>deleteLanguageModel</code> operation.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">DeleteLanguageModelParams</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="speechtotextv1.deletelanguagemodelparams.html#customization_id" class="tsd-kind-icon">customization_<wbr>id</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="speechtotextv1.deletelanguagemodelparams.html#headers" class="tsd-kind-icon">headers</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/speech-to-text/v1-generated.ts#L1882">speech-to-text/v1-generated.ts:1882</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
							<p>The GUID of the custom language model that is to be deleted. You must make the request with service credentials created for the instance of the service that owns the custom model.</p>
						</div>
					</div>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/speech-to-text/v1-generated.ts#L1883">speech-to-text/v1-generated.ts:1883</a></li>
						</ul>
					</aside>
				</section>
			</section>
					...
					<li class="current tsd-kind-class">
						...
						<ul>
							<li class="current tsd-kind-interface tsd-parent-kind-class">
								<a href="speechtotextv1.deletelanguagemodelparams.html" class="tsd-kind-icon">Delete<wbr>Language<wbr>Model<wbr>Params</a>
								<ul>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="speechtotextv1.deletelanguagemodelparams.html#customization_id" class="tsd-kind-icon">customization_<wbr>id</a>
									</li>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="speechtotextv1.deletelanguagemodelparams.html#headers" class="tsd-kind-icon">headers</a>
									</li>
								</ul>
							</li>
						</ul>
