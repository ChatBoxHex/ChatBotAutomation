...
<head>
	...
	<title>NluEnrichmentRelations | watson-developer-cloud</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="discoveryv1.nluenrichmentrelations.html">NluEnrichmentRelations</a>
				</li>
			</ul>
			<h1>Interface NluEnrichmentRelations</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			...
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">NluEnrichmentRelations</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="discoveryv1.nluenrichmentrelations.html#model" class="tsd-kind-icon">model</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/discovery/v1-generated.ts#L3137">discovery/v1-generated.ts:3137</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
							<p>For use with <code>natural_language_understanding</code> enrichments only.* The enrichement model to use with relationship extraction. May be a custom model provided by Watson Knowledge Studio, the public model for use with Knowledge Graph <code>en-news</code>, the default is<code>en-news</code>.</p>
						</div>
					</div>
				</section>
			</section>
					...
					<li class="current tsd-kind-class">
						...
						<ul>
							<li class="current tsd-kind-interface tsd-parent-kind-class">
								<a href="discoveryv1.nluenrichmentrelations.html" class="tsd-kind-icon">Nlu<wbr>Enrichment<wbr>Relations</a>
								<ul>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="discoveryv1.nluenrichmentrelations.html#model" class="tsd-kind-icon">model</a>
									</li>
								</ul>
							</li>
						</ul>
