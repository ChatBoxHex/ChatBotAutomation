...
<head>
	...
	<title>ListEnvironmentsResponse | watson-developer-cloud</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="discoveryv1.listenvironmentsresponse.html">ListEnvironmentsResponse</a>
				</li>
			</ul>
			<h1>Interface ListEnvironmentsResponse</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			...
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">ListEnvironmentsResponse</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="discoveryv1.listenvironmentsresponse.html#environments" class="tsd-kind-icon">environments</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<h3><span class="tsd-flag ts-flagOptional">Optional</span> environments</h3>
					<div class="tsd-signature tsd-kind-icon">environments<span class="tsd-signature-symbol">:</span> <a href="discoveryv1.environment.html" class="tsd-signature-type">Environment</a><span class="tsd-signature-symbol">[]</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/watson-developer-cloud/node-sdk/blob/3600fbdf3/discovery/v1-generated.ts#L3059">discovery/v1-generated.ts:3059</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
							<p>An array of [environments] that are available for the service instance.</p>
						</div>
					</div>
				</section>
			</section>
					...
					<li class="current tsd-kind-class">
						...
						<ul>
							<li class="current tsd-kind-interface tsd-parent-kind-class">
								<a href="discoveryv1.listenvironmentsresponse.html" class="tsd-kind-icon">List<wbr>Environments<wbr>Response</a>
								<ul>
									<li class=" tsd-kind-property tsd-parent-kind-interface">
										<a href="discoveryv1.listenvironmentsresponse.html#environments" class="tsd-kind-icon">environments</a>
									</li>
								</ul>
							</li>
						</ul>
